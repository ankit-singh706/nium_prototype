...
} from "./chunk-HAAP4DVF.js";
import {
  clsx_m_default
} from "./chunk-2TMMHHZA.js";
import {
  require_react_is
} from "./chunk-UU2HKMJO.js";
import {
  require_prop_types
...
var Portal = React19.forwardRef(function Portal2(props, ref) {
  ...
  const handleRef = useForkRef(React19.isValidElement(children2) ? children2.ref : null, ref);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
    ...
    Portal_default,
    {
      ...
      children: (0, import_jsx_runtime15.jsxs)(Root, _extends({}, rootProps, {
        children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime14.jsx)(BackdropComponent, _extends({}, backdropProps)) : null, (0, import_jsx_runtime14.jsx)(FocusTrap_default, {
          ...
          open,
          children: React25.cloneElement(children2, childProps)
        })]
      }))
    }
  );
...
function getOptionsFromChildren(children2) {
  ...
  React28.Children.forEach(children2, (node) => {
...
function useAutocomplete(props) {
  ...
  const ignoreFocus = React52.useRef(false);
  const firstFocus = React52.useRef(true);
  const inputRef = React52.useRef(null);
  const listboxRef = React52.useRef(null);
  const [anchorEl, setAnchorEl] = React52.useState(null);
  const [focusedTag, setFocusedTag] = React52.useState(-1);
  const defaultHighlighted = autoHighlight ? 0 : -1;
  const highlightedIndexRef = React52.useRef(defaultHighlighted);
  ...
  const resetInputValue = React52.useCallback((event, newValue) => {
  ...
  const [inputPristine, setInputPristine] = React52.useState(true);
  ...
  const syncHighlightedIndex = React52.useCallback(() => {
    if (!popupOpen) {
      return;
    }
  ...
  const isTouch = React52.useRef(false);
...
function GlobalStyles2(props) {
  return (0, import_jsx_runtime39.jsx)(GlobalStyles, _extends({}, props, {
...
var inputGlobalStyles = (0, import_jsx_runtime40.jsx)(GlobalStyles_default, {
  styles: {
...
var InputBase = React56.forwardRef(function InputBase2(inProps, ref) {
  ...
  return (0, import_jsx_runtime41.jsxs)(React56.Fragment, {
    children: [!disableInjectingGlobalStyles && inputGlobalStyles, (0, import_jsx_runtime41.jsxs)(Root, _extends({}, rootProps, !isHostComponent(Root) && {
      ...
      children: [startAdornment, (0, import_jsx_runtime40.jsx)(FormControlContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime40.jsx)(Input3, _extends({
          ownerState,
  ...
  return (0, import_jsx_runtime44.jsx)(NotchedOutlineRoot, _extends({
    ...
    children: (0, import_jsx_runtime44.jsx)(NotchedOutlineLegend, {
      ...
      children: withLabel ? (0, import_jsx_runtime44.jsx)("span", {
        ...
        _span5 || (_span5 = (0, import_jsx_runtime44.jsx)("span", {
...
var OutlinedInput = React60.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime46.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime46.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime45.jsxs)(React60.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
var InputLabel = React62.forwardRef(function InputLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime48.jsx)(InputLabelRoot, _extends({
    "data-shrink": shrink,
    ownerState,
    ref,
    className: clsx_m_default(classes.root, className)
...
var FormHelperText = React64.forwardRef(function FormHelperText2(inProps, ref) {
  ...
  return (0, import_jsx_runtime50.jsx)(FormHelperTextRoot, _extends({
    ...
    children: children2 === " " ? (
      // notranslate needed while Google Translate will not fix zero-width space issue
      _span6 || (_span6 = (0, import_jsx_runtime50.jsx)("span", {
        className: "notranslate",
        children: "​"
      }))
    ) : children2
...
var timeoutsShape = true ? import_prop_types39.default.oneOfType([import_prop_types39.default.number, import_prop_types39.default.shape({
  enter: import_prop_types39.default.number,
  exit: import_prop_types39.default.number,
  appear: import_prop_types39.default.number
}).isRequired]) : null;
var classNamesShape = true ? import_prop_types39.default.oneOfType([import_prop_types39.default.string, import_prop_types39.default.shape({
  enter: import_prop_types39.default.string,
  exit: import_prop_types39.default.string,
  active: import_prop_types39.default.string
}), import_prop_types39.default.shape({
  enter: import_prop_types39.default.string,
  enterDone: import_prop_types39.default.string,
  enterActive: import_prop_types39.default.string,
  exit: import_prop_types39.default.string,
  exitDone: import_prop_types39.default.string,
  exitActive: import_prop_types39.default.string
})]) : null;
...
Transition.propTypes = true ? {
   ...
   */
  nodeRef: import_prop_types40.default.shape({
    current: typeof Element === "undefined" ? import_prop_types40.default.any : function(propValue, key, componentName, location, propFullName, secret) {
      var value = propValue[key];
      return import_prop_types40.default.instanceOf(value && "ownerDocument" in value ? value.ownerDocument.defaultView.Element : Element)(propValue, key, componentName, location, propFullName, secret);
    }
  }),
  /**
   ...
   * ```
   */
  children: import_prop_types40.default.oneOfType([import_prop_types40.default.func.isRequired, import_prop_types40.default.element.isRequired]).isRequired,
  /**
   ...
   */
  mountOnEnter: import_prop_types40.default.bool,
  /**
   * By default the child component stays mounted after it reaches the `'exited'` state.
   * Set `unmountOnExit` if you'd prefer to unmount the component after it finishes exiting.
   */
  unmountOnExit: import_prop_types40.default.bool,
  /**
...
TransitionGroup.propTypes = true ? {
   ...
   */
  component: import_prop_types42.default.any,
  /**
   ...
   */
  childFactory: import_prop_types42.default.func
} : {};
...
ReplaceTransition.propTypes = true ? {
  in: import_prop_types43.default.bool.isRequired,
...
SwitchTransition.propTypes = true ? {
   ...
   * @type {'out-in'|'in-out'}
   */
  mode: import_prop_types44.default.oneOf([modes.in, modes.out]),
  /**
   * Any `Transition` or `CSSTransition` component.
   */
  children: import_prop_types44.default.oneOfType([import_prop_types44.default.element.isRequired])
} : {};
...
var Backdrop = React77.forwardRef(function Backdrop2(inProps, ref) {
  ...
  return (0, import_jsx_runtime57.jsx)(TransitionComponent, _extends({
    ...
    children: (0, import_jsx_runtime57.jsx)(BackdropRoot, _extends({
      "aria-hidden": true
    }, rootSlotProps, {
...
var _excluded41 = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "slotProps", "slots", "theme"];
...
var Modal = React78.forwardRef(function Modal2(inProps, ref) {
  ...
  return (0, import_jsx_runtime58.jsx)(ModalUnstyled_default, _extends({
    slots: {
      root: RootSlot,
...
var _excluded44 = ["className", "disabled", "IconComponent", "inputRef", "variant"];
...
var _span7;
var _excluded45 = ["aria-describedby", "aria-label", "autoFocus", "autoWidth", "children", "className", "defaultOpen", "defaultValue", "disabled", "displayEmpty", "IconComponent", "inputRef", "labelId", "MenuProps", "multiple", "name", "onBlur", "onChange", "onClose", "onFocus", "onOpen", "open", "readOnly", "renderValue", "SelectDisplayProps", "tabIndex", "type", "value", "variant"];
...
var SelectInput = React82.forwardRef(function SelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime64.jsxs)(React82.Fragment, {
...
var SvgIcon = React83.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  return (0, import_jsx_runtime66.jsxs)(SvgIconRoot, _extends({
    ...
    ownerState,
    children: [children2, titleAccess ? (0, import_jsx_runtime65.jsx)("title", {
...
var Select = React86.forwardRef(function Select2(inProps, ref) {
  ...
  return (0, import_jsx_runtime69.jsx)(React86.Fragment, {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-DFFXGOE4.js.map
